...
const Index = () => {
  ...
  useEffect(() => {
    ...
    let scroll1 = 0;
    let scroll2 = 0;
    const speed1 = 0.7; // px per frame (top row, left to right)
    const speed2 = 0.7; // px per frame (bottom row, right to left)

    function animate() {
      if (testimonialRow1Ref.current) {
        const el = testimonialRow1Ref.current;
        scroll1 += speed1;
        if (scroll1 > el.scrollWidth - el.clientWidth) scroll1 = 0;
        el.scrollLeft = scroll1;
      }
      if (testimonialRow2Ref.current) {
        const el = testimonialRow2Ref.current;
        scroll2 -= speed2;
        if (scroll2 < 0) scroll2 = el.scrollWidth - el.clientWidth;
        el.scrollLeft = scroll2;
      }
  ...
  return (
    <div className="min-h-screen bg-white w-screen overflow-hidden ">
      {/* Login Popup */}
...
<div className="flex justify-center mt-[60px] sm:mt-[70px] md:mt-[80px] lg:mt-[90px] xl:mt-[101px] px-4">
  <div className="flex items-center bg-white border border-gray-200 rounded-[12px] sm:rounded-[14px] md:rounded-[15px] lg:rounded-[16px] xl:rounded-[17px] px-3 sm:px-4 md:px-5 lg:px-5 xl:px-6 py-2 sm:py-3 md:py-3 lg:py-3.5 xl:py-4 h-[45px] sm:h-[50px] md:h-[55px] lg:h-[58px] xl:h-[60px] w-[200px] sm:w-[220px] md:w-[240px] lg:w-[260px] xl:w-[275px]">
...
<section className="text-center px-4 sm:px-6 md:px-8 lg:px-12 mt-[30px] sm:mt-[40px] md:mt-[50px] lg:mt-[60px]">
  <div className="max-w-6xl mx-auto">
    <h1 className="text-[28px] sm:text-[36px] md:text-[48px] lg:text-[56px] xl:text-[64px] font-medium leading-[36px] sm:leading-[44px] md:leading-[60px] lg:leading-[72px] xl:leading-[82px] text-gray-700 mb-4 sm:mb-6 md:mb-8">
    ...
    <p className="text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] leading-[22px] sm:leading-[26px] md:leading-[28px] lg:leading-[30px] text-[#989CA4] mb-8 sm:mb-10 md:mb-12 max-w-full sm:max-w-3xl md:max-w-4xl mx-auto">
    ...
    <div className="relative max-w-full sm:max-w-2xl md:max-w-3xl mx-auto mb-8 sm:mb-10 md:mb-12">
      {/* Search Icon Image on the left */}
      <img
        src="/src/images/search-line.png"
        alt="Search Icon"
        className="absolute left-3 sm:left-4 md:left-5 top-1/2 transform -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5"
      />
      
      {/* Right Rectangle Image with Arrow Icon */}
      <div className="absolute top-1/2 right-3 sm:right-4 md:right-5 transform -translate-y-1/2 h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10">
        <img
        ...
        <img
          ...
          alt="Arrow"
          className="absolute top-1/2 left-1/2 w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 transform -translate-x-1/2 -translate-y-1/2"
        />
      </div>
    ...
    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-6 sm:mb-8">
      {[
        ...
        <button 
          ...
          className="bg-white border border-[#D0DEFF] rounded-[12px] sm:rounded-[15px] px-3 sm:px-4 py-2 sm:py-3 text-[13px] sm:text-[14px] md:text-[15px] text-gray-600 hover:bg-gray-50 transition-colors whitespace-nowrap"
        >
          {service}
        </button>
      ))}
    ...
    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-12 sm:mb-14 md:mb-16">
      {[
...
<div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 bg-white">
  {/* Header */}
  <div className="text-center mb-8 sm:mb-10 lg:mb-12 font-roboto">
  ...
  {/* Categories Grid */}
  <div className="border-2 border-gray-200 rounded-lg overflow-hidden max-w-4xl mx-auto">
    <div className="grid grid-cols-2 sm:grid-cols-4">
      
      {/* Software & Tech - 1 */}
      <div className="relative p-4 sm:p-5 lg:p-6 cursor-pointer bg-white hover:bg-gray-50 border-b border-r border-gray-200 transition-colors duration-200">
      ...
      {/* UI/UX Design - 1 */}
      <div className="relative p-4 sm:p-5 lg:p-6 cursor-pointer bg-white hover:bg-gray-50 border-b border-gray-200 sm:border-r transition-colors duration-200">
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="p-2 rounded-lg bg-gray-100 text-gray-600 flex-shrink-0">
            <div className="relative">
              <img 
      ...
      {/* Video Editing - 1 */}
      <div className="relative p-4 sm:p-5 lg:p-6 cursor-pointer bg-white hover:bg-gray-50 border-b border-gray-200 transition-colors duration-200">
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="p-2 rounded-lg bg-gray-100 text-gray-600 flex-shrink-0">
            <div className="relative">
              <img 
      ...
      {/* Software & Tech - 2 */}
      <div className="relative p-4 sm:p-5 lg:p-6 cursor-pointer bg-white hover:bg-gray-50 border-r border-b border-gray-200 transition-colors duration-200">
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="p-2 rounded-lg bg-gray-100 text-gray-600 flex-shrink-0">
            <div className="relative">
              <img 
      ...
      {/* Video Editing - 2 */}
      <div className="relative p-4 sm:p-5 lg:p-6 cursor-pointer bg-white hover:bg-gray-50 transition-colors duration-200">
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="p-2 rounded-lg bg-gray-100 text-gray-600 flex-shrink-0">
            <div className="relative">
              <img 
...
<div className="w-full">
  ...
  <div className="relative overflow-hidden">
    <div 
      ...
      style={{ transform: `translateX(-${currentScrollPosition * (320 + 24)}px)` }}
    >
      {Array(12).fill(null).map((_, index) => {
        ...
        return (
          <div 
            key={`card-${index}`} 
            className="bg-white border border-gray-200 rounded-[20px] sm:rounded-[25px] p-3 sm:p-4 md:p-5 lg:p-6 shadow-sm hover:shadow-lg transition-shadow cursor-pointer flex-shrink-0"
            style={{ width: '320px' }}
          >
            {/* Profile Header */}
            ...
            {/* View Profile Button */}
            <button 
              className="w-full bg-blue-600 text-white rounded-[6px] sm:rounded-[8px] py-1.5 sm:py-2 md:py-2.5 text-xs sm:text-xs md:text-sm lg:text-[14px] font-medium hover:bg-blue-700 transition-colors"
  ...
  <div className="flex justify-end mb-6 sm:mb-8 mt-4 sm:mt-6">
    <button 
      className="bg-white border border-gray-300 rounded-full w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center hover:bg-gray-50 transition-colors shadow-sm"
...
{/* Explore All Top Talent Button */}
    <div className="text-center mb-8 sm:mb-16">
      <button 
        className="text-base sm:text-[18px] font-medium text-white rounded-[12px] px-6 sm:px-8 py-3 sm:py-4 transition-all duration-200 hover:scale-105 active:scale-95 w-full sm:w-auto"
        style={{ background: "linear-gradient(270deg, #71baff 0%, #bde4ff 100%)" }}
        onClick={() => handleNavigation('/find-freelancers')}
      >
...
<section className="relative overflow-hidden mb-16">
  ...
  <div className="relative px-4 py-8 sm:py-16">
    {/* Stats Section */}
    <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-8 mb-8 sm:mb-16">
      <div className="bg-blue-50 rounded-[18px] px-4 sm:px-8 py-3 sm:py-4">
      ...
      <button className="bg-blue-50 rounded-[18px] px-4 sm:px-8 py-3 sm:py-4 text-[16px] sm:text-[22px] font-medium text-black">
        Trusted by 10k+
      </button>
      <div className="bg-blue-50 rounded-[18px] px-4 sm:px-8 py-3 sm:py-4">
    ...
    {/* Title Section */}
    <div className="text-center mb-8 sm:mb-16">
      <h2 className="text-[24px] sm:text-[36px] lg:text-[48px] font-bold leading-tight text-black mb-4 sm:mb-6">
    ...
    {/* Full Width Continuous Scrolling Testimonials */}
    <div className="relative w-full -mx-4 sm:-mx-16">
      {/* First Row - Continuous Left to Right */}
      <div className="testimonials-row-1 overflow-hidden mb-6 w-full">
        <div 
          className="flex space-x-4 sm:space-x-6 animate-marquee-left whitespace-nowrap"
          style={{
            width: "200%"
          }}
        >
          ...
          {[...Array(3)].map((_, setIndex) => 
            Array(10).fill(null).map((_, index) => (
              <div
                ...
                className="bg-white border-2 border-gray-100 rounded-[15px] p-4 sm:p-6 flex-shrink-0 w-[280px] sm:w-[320px] md:w-[350px] transition-all duration-300 hover:scale-105 hover:shadow-lg inline-block whitespace-normal"
              >
                <div className="flex items-center mb-3 sm:mb-4">
                  <img
      ...
      {/* Second Row - Continuous Right to Left */}
      <div className="testimonials-row-2 overflow-hidden w-full">
        <div 
          className="flex space-x-4 sm:space-x-6 animate-marquee-right whitespace-nowrap"
          style={{
            width: "200%"
          }}
        >
